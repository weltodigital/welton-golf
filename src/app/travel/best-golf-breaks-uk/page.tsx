    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <Card className="mt-8">
            <CardHeader>
              <CardTitle>Plan More Golf Adventures</CardTitle>
              <CardDescription>
                Tools and guides to help you discover more golf destinations and plan perfect trips
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href="/break-90/how-to-break-90-golf" className="flex items-center gap-3 p-3 border border-slate-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-600">Improve your game for these courses</div>
                      </div>
                    </Link>
                  </div>
                </div>
