        ...
        <div className="max-w-6xl mx-auto">
          ...
          <nav className="text-sm text-gray-600 mb-4">
            <ol className="flex space-x-2">
              ...
              <li className="before:content-['/'] before:mx-2 text-gray-900">Wind & Elevation Adjuster</li>
            </ol>
          </nav>
                ...
                {adjustments.length === 0 ? (
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {adjustments.map((adjustment) => (
                      <div key={adjustment.id} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <p className="text-gray-600 dark:text-gray-400">Base Distance:</p>
                            <p className="font-medium">{adjustment.baseDistance} yards</p>
                          </div>
                          <div>
                            <p className="text-gray-600 dark:text-gray-400">Adjusted Distance:</p>
          ...
          <Card className="mt-8">
            ...
            <CardContent className="prose prose-sm max-w-none">
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-3 text-black">Complete Guide to Wind and Elevation</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h4 className="font-semibold mb-3 text-black">Wind Effects on Ball Flight:</h4>
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-black">Elevation Impact:</h4>
                  <ul className="text-sm space-y-2 text-black">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-black">Course Management Tips:</h4>
                  <div className="text-sm text-black space-y-1">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div>
                  <h4 className="font-semibold mb-3 text-black">Wind Adjustment Guidelines:</h4>
                  <div className="text-sm text-black space-y-1">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-black">Elevation Guidelines:</h4>
                  <div className="text-sm text-black space-y-1">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-black">Combined Effects:</h4>
                  <div className="text-sm text-black space-y-1">
              ...
              <div className="mt-6 p-6 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <h4 className="font-semibold mb-3 text-black">Why Use Our Wind & Elevation Adjuster?</h4>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-black mb-2"><strong>✓ Precise Calculations:</strong> Based on proven golf physics</p>
                    <p className="text-black mb-2"><strong>✓ Multiple Factors:</strong> Wind, elevation, and temperature</p>
                    <p className="text-black"><strong>✓ Course Management:</strong> Improve decision making</p>
                  </div>
                  <div>
                    <p className="text-black mb-2"><strong>✓ Save History:</strong> Track your adjustments</p>
                    <p className="text-black mb-2"><strong>✓ Educational:</strong> Learn environmental effects</p>
                    <p className="text-black"><strong>✓ Free Tool:</strong> No cost for calculations</p>
                  </div>
                </div>
              </div>
